...
func TestBase_Unmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "parent null",
			data: []byte(
				`{"id":1,"name":"top-level","description":null,"pathName":"top-level","parent":null,"proxyId":null,"childrenIDs":[],"maxretries":0,"weight":2000,"active":true,"type":"group","interval":60,"retryInterval":60,"resendInterval":0,"upsideDown":false,"notificationIDList":{},"tags":[],"maintenance":false}`,
			),
