...
func TestMonitorWebsocketUpgrade_Unmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantJSON: `{"accepted_statuscodes":["1000","1001"],"active":true,"authDomain":"","authMethod":"basic","authWorkstation":"","basic_auth_pass":"wspass","basic_auth_user":"wsuser","body":"","cacheBust":false,"conditions":[],"description":"WebSocket with basic auth","expiryNotification":false,"headers":"{\"X-Custom\":\"value\"}","httpBodyEncoding":"json","id":21,"ignoreTls":true,"interval":120,"maxredirects":10,"maxretries":3,"method":"GET","name":"ws-basic","notificationIDList":{},"oauth_audience":"","oauth_auth_method":"client_secret_basic","oauth_client_id":"","oauth_client_secret":"","oauth_scopes":"","oauth_token_url":"","parent":null,"proxyId":null,"resendInterval":0,"retryInterval":120,"timeout":30,"tlsCa":"","tlsCert":"","tlsKey":"","type":"websocket-upgrade","upsideDown":false,"url":"wss://secure.example.com/ws","wsIgnoreSecWebsocketAcceptHeader":false,"wsSubprotocol":""}`,
		},
		{
